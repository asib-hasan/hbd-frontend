        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="section-header">
                ...
                <h2
                    ...
                    Top Doctors & Hospitals <span class="text-gradient">Near You</span>
                </h2>
                ...
                <NuxtLink v-for="(location, index) in locations.filter(l => l.featured)" :key="location.slug"
                    ...
                    <div class="absolute inset-0 p-6 flex flex-col justify-end">
                        <div class="flex items-center gap-2 text-primary-foreground/80 mb-2">
                            ...
                            <span class="text-sm font-medium">Best Doctors in</span>
                        </div>
                        ...
                        <div class="flex items-center gap-6 mb-4">
                            <div class="flex items-center gap-2 text-primary-foreground/90">
                                ...
                                <span class="text-sm font-medium">{{ location.doctors }}+ Doctors</span>
                            </div>
                            <div class="flex items-center gap-2 text-primary-foreground/90">
                                <UIcon name="i-lucide-building-2" class="w-4 h-4" />
                                <span class="text-sm font-medium">{{ location.hospitals }} Hospitals</span>
                            </div>
                        </div>
