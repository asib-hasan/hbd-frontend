...
<template>
    ...
    <div v-if="pending" class="min-h-screen bg-background flex flex-col items-center justify-center">
        ...
        <p class="text-muted-foreground font-medium mt-4 animate-pulse">Loading article...</p>
    </div>
    ...
    <div v-else-if="!post" class="min-h-screen bg-background flex flex-col">
        <div class="flex-grow flex items-center justify-center text-center px-4">
            <div class="max-w-md">
                ...
                <h1 class="text-3xl font-display font-bold text-foreground mb-3">Article Not Found</h1>
                <p class="text-muted-foreground mb-8 text-lg">The article you're looking for doesn't exist or has been
                    removed.</p>
                <NuxtLink to="/blog">
        ...
        <section class="pt-24 pb-8 lg:pt-28 lg:pb-12 bg-gradient-hero-subtle relative overflow-hidden">
            ...
            <div class="container mx-auto px-4 relative z-10">
                ...
                <nav class="flex items-center gap-2 text-sm text-muted-foreground mb-6 animate-fade-up">
                    ...
                    <UIcon name="i-lucide-chevron-right" class="w-3.5 h-3.5" />
                    <span class="text-foreground font-medium line-clamp-1 max-w-[200px]">{{ post.title_en }}</span>
                </nav>
                    ...
                    <div class="flex flex-wrap items-center gap-5 animate-fade-up stagger-3">
                        <div class="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <div>
                                ...
                                <span class="text-xs">Official Post</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 pt-8 border-t border-border/50">
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 class="font-semibold font-display text-foreground text-sm">Share this
                                            article</h4>
                                        <p class="text-xs text-muted-foreground">Help others discover this content</p>
                                    </div>
                                </div>
                        ...
                        <div class="space-y-6">
                            <div v-if="relatedBlogs.length > 0">
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <h3 class="font-display font-bold text-lg text-foreground">Related Articles</h3>
                                </div>
                                <div class="space-y-4">
                            ...
                            <div v-else
                                ...
                                <p class="text-sm text-muted-foreground font-medium">No related articles yet</p>
                                <NuxtLink to="/blog"
